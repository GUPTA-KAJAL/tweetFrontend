  ...
  const submitHandler=async(e)=>{
    ...
    if(isLogin){
      ...
      try {
        ...
        dispatch(getUser(res?.data?.user)) //jaise hi aapne login kia wo user ki initial state daaldega
  ...
  return (
    <div className='w-screen h-screen flex items-center justify-center'>
      <div className='flex items-center justify-evenly w-[80%]'>
        <div>
        <img width={"500px"} src="https://th.bing.com/th/id/OIP.1lm9KjprReA8-CMRPriawgHaEK?rs=1&pid=ImgDetMain" alt="TwitterLogo"/>
        </div>
        <div>
          <div className='my-5'>
