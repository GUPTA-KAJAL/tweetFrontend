        ...
        <div>
            <div className='flex items-center justify-evenly border-b border-gray-200'>
                ...
                <div onClick={followingHandler} className={`${!isActive ? "border-b-4 border-blue-600" : "border-b-4 border-transparent"} cursor-pointer hover:bg-gray-200 w-full text-center px-4 py-3`}>
                    <h1 className='font-semibold text-gray-600 cursor-pointer'>Following</h1>
                </div>
            </div>
            ...
            <div>
                ...
                <div className='flex items-center justify-between p-4 border-b border'>
                    ...
                    <button onClick={submitHandler} className='px-4 py-1 border-none text-lg bg-[#1D9BF0] rounded-full text-white'>Post</button>
                </div>
            </div>
        </div>
    </div>
